...
import { Leaf, Globe, Sun } from 'lucide-react';
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <span className="text-subheadline text-solterix-muted">
                Sustainable solutions that protect our climate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Globe className="w-5 h-5 text-solterix-mint mt-0.5 flex-shrink-0" />
              <span className="text-subheadline text-solterix-muted">
                Innovations that benefit the world today.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-solterix-mint mt-0.5 flex-shrink-0" />
              <span className="text-subheadline text-solterix-muted">
